...
const COUNTRY_LABELS: Record<string, string> = Object.fromEntries(COUNTRIES.map((c) => [c.code, c.label]));

export function getCountryLabel(code: string): string {
  return COUNTRY_LABELS[code] ?? code;
}

// Domestic base — the merchant's home country.
export const DOMESTIC_COUNTRY_CODE = "AT";

// EU member states (used for the mid-tier shipping zone).
...
export type ShippingZone = "domestic" | "eu" | "row";

// Placeholder rates in EUR for a ~3-4kg parcel — adjust to your real carrier pricing.
