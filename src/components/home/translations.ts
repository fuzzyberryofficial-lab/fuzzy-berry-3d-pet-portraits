...
export const TR: Record<Lang, HomeTranslation> = {
  en: {
    ...
    dropHero: "Drop a horizontal cutout photo of your pet (no background)",
    ...
    dropCraftVideo: "Click to upload a video of the crafting process",
    boxKicker: "Unboxing",
    boxTitle: "What's Inside Your Box",
    dropBox: "Drop an unboxing photo",
  ...
  de: {
    ...
    dropHero: "Horizontales Freisteller-Foto Ihres Haustiers hierher ziehen (ohne Hintergrund)",
    ...
    dropCraftVideo: "Klicken, um ein Video vom Herstellungsprozess hochzuladen",
    boxKicker: "Auspacken",
    boxTitle: "Das ist in Ihrer Box",
    dropBox: "Auspack-Foto hierher ziehen",
    privacy: "Datenschutz",
